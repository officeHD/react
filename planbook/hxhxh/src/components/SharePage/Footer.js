...
export default class Footer extends Component {
    ...
    share(){
    	...
    	let test=`${origin}/?type=pc&workNum=${this.props.staffmes.workNum}&productId=HXHXH001A&pid=${sharepid}#/share`
    	console.log(test)
        if(window.minsheng){
           window.minsheng.share(test,"华夏红","人性化设计，贴心显关爱",`/static/img/lifeInsurance/hxhxh.png`)
        }else{
          tianbai.share(test+"@华夏红@人性化设计，贴心显关爱@/static/img/lifeInsurance/hxhxh.png")  
        }
    }
    render() {
