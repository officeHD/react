...
module.exports = {
    ...
    changeMaininsure: function(text) {
        var action = {
            type: 'changeMaininsure',
            text: text
        };
        AppDispatcher.dispatch(action);
    },
    changeMaintype: function(text) {
        var action = {
            type: 'changeMaintype',
            text: text
        };
    ...
    changeSubinsureC: function(text) {
        var action = {
            type: 'changeSubinsureC',
            text: text
        };
        AppDispatcher.dispatch(action);
    },
