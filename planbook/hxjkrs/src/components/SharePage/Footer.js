...
export default class Footer extends Component {
    ...
    share(){
    	...
    	let test=`${origin}/?type=pc&workNum=${this.props.staffmes.workNum}&productId=HXJKRS001A&pid=${sharepid}#/share`
    	console.log(test)
        if(window.minsheng){
           window.minsheng.share(test,"健康人生","33+77，高性价终身重疾",`/static/img/lifeInsurance/hxjkrs.png`)
        }else{
          tianbai.share(test+"@健康人生@33+77，高性价终身重疾@/static/img/lifeInsurance/hxjkrs.png")  
        }
    }
    render() {
