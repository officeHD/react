...
export default class Footer extends Component {
    ...
    share(){
    	...
    	let test=`${origin}/?type=pc&workNum=${this.props.staffmes.workNum}&productId=LAK00O1&pid=${sharepid}#/share`
    	console.log(test)
        if(window.minsheng){
           window.minsheng.share(test,"乐安康","60+22+双豁免",`/static/img/lifeInsurance/leankang2.png`)
        }else{
          tianbai.share(test+"@乐安康@60+22+双豁免@/static/img/lifeInsurance/leankang2.png")  
        }
    }
    render() {
