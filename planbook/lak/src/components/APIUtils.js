...
export function getDataFromUrl() {
    ...
    AppActionCreators.initAppProduct("LAK00O1");
    InsuranceActionCreators.initInsProduct("LAK00O1");
...
export function saveInsuranceInfo() {
    ...
    let cb = msg => {
        if (msg.result.toString() === '1') {
            ...
            window.location = "?type=" + type + "&workNum=" + workNum + "&productId=LAK00O1&pid=" + msg.id + "#/share";
