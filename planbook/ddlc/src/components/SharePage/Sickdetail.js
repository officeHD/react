          ...
          <div className={style.cell}>
            ...
            <div className={style.sick_content}>
              ...
              <div className={style.operation}>
                ...
                <label onClick={this.setCenter}>
                   <span className={this.state.center?style.active:''}>轻症</span>
                </label>
                <label onClick={this.setRight}>
                   <span className={this.state.right?style.active:''}>轻症</span>
                </label>
              </div>
              <div className={style.layer_content}>
                {this.state.left?
                  <div className={style.left_content}>
                    ...
                    30.严重冠心病<br/>
                    31.严重心肌病<br/>
                    32.系统性红斑狼疮－III型或以上狼疮性肾炎<br/>
                    33.因职业关系导致的人类免疫缺陷病毒感染<br/>
                    34.经输血导致的人类免疫缺陷病毒感染<br/>
                    35.严重克隆病<br/>
                    36.严重溃疡性结肠炎<br/>
                    37.1型糖尿病<br/>
                    38.肺源性心脏病<br/>
                    ...
                    56.严重肌营养不良症<br/>
                    57.严重心肌炎<br/>
                    58.肝豆状核变性(或称Wilson病)<br/>
                    59.侵蚀性葡萄胎(或称恶性葡萄胎)<br/>
                    60.破裂脑动脉瘤夹闭手术<br/>
                    61.需手术切除的嗜铬细胞瘤<br/>
                    62.进行性核上性麻痹(Steele- Rchardson—Olszewski综合征)<br/>
                    63.严重幼年型类风湿性关节炎<br/>
                    64.严重肠道疾病并发症(本项保险责任仅在被保险人18周岁以前提供<br/>保障)
                    65.严重瑞氏综合症（Reye 综合征，也称赖氏综合征、雷氏综合征）<br/>
                    66.严重自身免疫性肝炎<br/>
                    67.严重的III度房室传导阻滞<br/>
                    68.细菌性脑脊髓膜炎<br/>
                    69.严重感染性心内膜炎<br/>
                  ...
                  14.轻度脑炎或脑膜炎后遗症<br/>
                  15.肺泡蛋白质沉积症<br/>
                  16.中度听力受损（三周岁以上理赔）<br/>
                  17.中度瘫痪<br/>
                  18.肾脏切除<br/>
                  19.早期运动神经性疾病<br/>
                  20.可逆性再生障碍性贫血<br/>
                  21.因肾上腺腺瘤所致的肾上腺切除术<br/>
                  22.心脏起搏器或除颤器植入<br/>
                  23.严重系统性红斑狼疮<br/>
                  24.胆道系统重建手术<br/>
                  25.角膜移植<br/>
