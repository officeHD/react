...
export default class Footer extends Component {
    ...
    share(){
    	...
    	let test=`${origin}/?type=pc&workNum=${this.props.staffmes.workNum}&productId=ZHYSHH001C&pid=${sharepid}#/share`
    	 
        if(window.minsheng){
           window.minsheng.share(test,"一生呵护C","120种轻症+重疾",`/static/img/lifeInsurance/zhgats2.png`)
        }else{
          tianbai.share(test+"@一生呵护C@120种轻症+重疾@/static/img/lifeInsurance/zhgats2.png")  
        }
    }
    render() {
