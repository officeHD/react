...
export function getDataFromUrl() {
    ...
    AppActionCreators.initAppProduct("HXHXF001A");
    InsuranceActionCreators.initInsProduct("HXHXF001A");
...
export function saveInsuranceInfo() {
    ...
    let cb = msg => {
        ...
        if (msg.result.toString() === '1') {
            ...
            window.location = "?type=" + type + "&workNum=" + workNum + "&productId=HXHXF001A&pid=" + msg.id + "#/share";
