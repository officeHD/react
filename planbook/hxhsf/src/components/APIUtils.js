...
export function getDataFromUrl() {
    ...
    AppActionCreators.initAppProduct("HXHSF001A");
    InsuranceActionCreators.initInsProduct("HXHSF001A");
...
export function getInsuranceInfo() {
    ...
    console.log(stakeholder.payendyear)
    ...
    let datas = {
        ...
        varietyCode: "HXHSF001A",
        amnt: 50000*stakeholder.mainNum,
...
export function saveInsuranceInfo() {
    ...
    let cb = msg => {
        if (msg.result.toString() === '1') {
            ...
            window.location = "?type=" + type + "&workNum=" + workNum + "&productId=HXHSF001A&pid=" + msg.id + "#/share";
