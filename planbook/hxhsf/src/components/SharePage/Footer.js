...
export default class Footer extends Component {
    ...
    share(){
    	...
    	let test=`${origin}/?type=pc&workNum=${this.props.staffmes.workNum}&productId=HXHSF001A&pid=${sharepid}#/share`
    	console.log(test)
        if(window.minsheng){
           window.minsheng.share(test,"护身福","人生多少事，一路护身福",`/static/img/lifeInsurance/hxhsf.png`)
        }else{
          tianbai.share(test+"@护身福@人生多少事，一路护身福@/static/img/lifeInsurance/hxhsf.png")  
        }
    }
    render() {
