...
export function getDataFromUrl() {
    ...
    AppActionCreators.initAppProduct("LAX00O1");
    InsuranceActionCreators.initInsProduct("LAX00O1");
...
export function saveInsuranceInfo() {
    ...
    let cb = msg => {
        if (msg.result.toString() === '1') {
            ...
            window.location = "?type=" + type + "&workNum=" + workNum + "&productId=LAX00O1&pid=" + msg.id + "#/share";
