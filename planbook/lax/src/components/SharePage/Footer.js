...
export default class Footer extends Component {
    ...
    share(){
    	...
    	let test=`${origin}/?type=pc&workNum=${this.props.staffmes.workNum}&productId=LAX00O1&pid=${sharepid}#/share`
    	console.log(test)
        if(window.minsheng){
           window.minsheng.share(test,"乐安心","重疾陪完不终止",`/static/img/lifeInsurance/leanxin2.png`)
        }else{
          tianbai.share(test+"@乐安心@重疾陪完不终止@/static/img/lifeInsurance/leanxin2.png")  
        }
    }
    render() {
