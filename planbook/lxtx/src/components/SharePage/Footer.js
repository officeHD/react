...
export default class Footer extends Component {
    ...
    share(){
    	...
    	let test=`${origin}/?type=pc&workNum=${this.props.staffmes.workNum}&productId=LXTX00O1&pid=${sharepid}#/share`
    	console.log(test)
        if(window.minsheng){
           window.minsheng.share(test,"乐行天下","百万护驾，乐行天下",`/static/img/lifeInsurance/lexintianxia2.png`)
        }else{
          tianbai.share(test+"@乐行天下@百万护驾，乐行天下@/static/img/lifeInsurance/lexintianxia2.png")  
        }
    }
    render() {
