...
export function changeInsurePrice() {
    ...
    let datas = {
        ...
        brithDay: stakeholder.bbrBirthday || "1992-01-01",
...
export function orderOperation(type) {
    ...
    let jsdata = {
        ...
        "TradeData": {
            ...
            "ContInfo": {
                "LCCont": {
                    "OldAppointMentNo": "KM220000000000001505",
                    "AppointMentNo": "KM220000000000001505",
                    "CompanyFlag": "LIS",
                    "ManageCom": "",
                    "PolApplyDate": "2017-10-10",
                    "Operator": "00000017",
                    "GetPolMode": "2",
                    "SellType": "11",
                    "SaleChnl": "7",
                ...
                "LCInsureds": [{
                    ...
                    "LCInsured": [{
                        ...
                        "RelationToAppnt": stakeholder.relation,
                        "LCAddress": {
                            "Province": stakeholder.bbrProvince.no,
                            "City": stakeholder.bbrCity.no,
                            "County": stakeholder.bbrCountry.no,
                            "PostalAddress": stakeholder.bbrAdd,
                            "ZipCode": stakeholder.bzipCode,
