...
import Job from './Job';
import { DatePicker,Picker,List,Toast } from 'antd-mobile';
    ...
    changeTbrid(event){
        ...
        if ((val.length === 15) || (val.length === 18)) {
            if(this.props.stakeholder.bbrAge<18){
                if(this.props.stakeholder.tbrAge-this.props.stakeholder.bbrAge<18){
                    Toast.info("被投保人小于十八岁，投保关系必须为父母",2)
                }
            }
                       ...
                       <li className={style.list}>
                        ...
                        <li className={style.list}>
                          ...
                          <li className={style.list}>
                            ...
                            <Bigjob 
                                ...
                                job={this.props.stakeholder.bigjob} 
                            />
                        </li>    
                        <li className={style.list}>
                            <label>职业小类</label>
                            <Smalljob 
                                ...
                                job={this.props.stakeholder.smalljob} 
                                bigjob={this.props.stakeholder.bigjob}
                            />
                        ...
                        <li className={style.list}>
                            ...
                            <Job 
                                ...
                                job={this.props.stakeholder.job} 
                                bigjob={this.props.stakeholder.bigjob} 
                                smalljob={this.props.stakeholder.smalljob}
                            />
                        </li> 
                        <li className={style.list}>
                            <label>电子邮箱</label>
