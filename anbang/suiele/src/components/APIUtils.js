...
//输入姓名获取用户信息
export function getUserInfoAPI(key) {
    let workNum = getUrlParam('workNum');
    let datas = {
        key: key,
        workNum: workNum
        ...
        "TradeData": {
            ...
            "ContInfo": {
                ...
                "LCAppnt": {
                    ...
                    "AppntSex": stakeholder.bbrSex,
                    "AppntBirthday": stakeholder.bbrBirthday,
                    "AppntIDType": "0",
