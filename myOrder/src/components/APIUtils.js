...
export function getDataFromUrl(page, status, gysName) {
    ...
    if (isMock) {
        ...
        zAJAX(`${ctx}/mobile/lifeInsurance/anbang/app_order_list`, datas, cb)
    }
...
export function getOrderDetail(id,type) {
    ...
    let cb = msg => {
        ...
        AppActionCreators.saveUserDetail(meg);
        InsuranceActionCreators.saveResult(meg);
        console.log(meg);
       if(type==="detail"){
    ...
    if (isMock) {
        ...
        zAJAX(`${ctx}/mobile/lifeInsurance/anbang/detail `, datas, cb)
    }
};
...
export function getCompanyList() {
    ...
    if (isMock) {
        ...
        zAJAX(`${ctx}/mobile/lifeInsurance/anbang/getProductList `, datas, cb)
    }
...
export function applyPay() {
    ...
    let datas = {
        workNum: getUrlParam('workNum')||stakeholder.workNum,
