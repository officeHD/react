...
function saveResult(obj) {
    ...
    stakeholder.tbr = obj.tbr;
    stakeholder.bbr = obj.bbr;
    stakeholder.carInfo = obj.carInfo;
 
    stakeholder.carOrderQuote = obj.carOrderQuote; 
    stakeholder.vehicleInfo = obj.vehicleInfo; 
