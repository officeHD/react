...
import SureHealthContainer from './containers/SureHealthContainer'
...
const step1ImgContainer = (location, cb) => {
    require.ensure([], require => {
        cb(null, require('./containers/step1ImgContainer').default);
    }, 'step1ImgContainer');
}
...
render(
    <Provider store={store}>
        <Router history={hashHistory} onUpdate={() => window.scrollTo(0, 0)}>
            ...
            <Route path="/" component={SureHealthContainer} />


            <Route path="/sure" component={SureHealthContainer} />
            ...
            <Route path="/uploadImg" getComponent={step1ImgContainer} />
