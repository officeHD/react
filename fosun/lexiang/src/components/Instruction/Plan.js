...
export default class OutPut extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <LazyLoad >
          <img className={style.top_img} src={require(`../asset/img/banner/banner.jpg`)} />
        </LazyLoad >
        ...
        <Detail34010 />
        {this.state.show ? <div className={style.tralModel} style={{ zIndex: "1" }}>
          <div className={style.tralContent}>
          <Plans title="社保" >
            <RadioSelector a="有" b="无" selected={insuredsData.insuSocialSecFlag === "N"} onSelect={onChangeInsuSocialSecFla} />
          </Plans>
            <DatePicker
