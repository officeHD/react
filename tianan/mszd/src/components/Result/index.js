...
export default class Result extends Component {
    ...
    pageview(){
            window.open('',"_blank").location= this.state.payResult.epolicyAddress     
   }
    render() {
                ...
                <ul className={style.content_ul}>
                    <li className={style.list_title}>
                        <label className={style.list_t}>支付金额<span className={style.lists}></span></label>
                         ...
                         <span className={style.red}>{this.state.stakeholder.insurePrice}元</span> 
                    </li>
                </ul>
               <ul className={style.content_ul}>
                    ...
                    <li className={style.list}>
                        <label>保单号<span className={style.lists}></span></label>
                          {this.state.payResult.policyNo}
                    </li>
                    <li className={style.list}>
                        <label>流水号<span className={style.lists}></span></label>
                          {this.state.payResult.waterNo}
                    </li>
                    <li className={style.list}>
                        <label>保险起期<span className={style.lists}></span></label>
                          {this.state.payResult.startDate}
                    </li>
                    <li className={style.list}>
                        <label>保险止期<span className={style.lists}></span></label>
                          {this.state.payResult.endDate}
                    </li>
                     <li className={style.list}>
